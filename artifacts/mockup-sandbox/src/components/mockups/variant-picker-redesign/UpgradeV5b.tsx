    ...
    <div className="min-h-screen p-5" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', color: TEXT, background: "#fff" }}>
      <div className="max-w-[440px] mx-auto flex flex-col" style={{ gap: 12 }}>
        <div style={{ marginBottom: 4 }}>
          <span style={{ fontWeight: 700, fontSize: 14, letterSpacing: "-0.01em" }}>V5b: Detail Only — Clean</span>
          <p style={{ fontSize: 11, color: SUB, marginTop: 2 }}>No extra section — just rich copy that does the selling on its own</p>
        </div>

        <button type="button" onClick={() => setGlazeSelected(!glazeSelected)} style={{
          display: "flex", alignItems: "center", gap: 14, padding: 14, width: "100%",
          border: `1.5px solid ${glazeSelected ? TEXT : BL}`, borderRadius: R,
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <span style={{ fontSize: 11.5, color: SUB, lineHeight: 1.45, display: "block" }}>
              Nano-structured acrylic that virtually eliminates reflections. Blocks 99% of UV light. The same technology used by the National Gallery and Tate to protect priceless works.
            </span>
          </div>
        ...
        <button type="button" onClick={() => setFrameSelected(!frameSelected)} style={{
          display: "flex", alignItems: "center", gap: 14, padding: 14, width: "100%",
          border: `1.5px solid ${frameSelected ? TEXT : BL}`, borderRadius: R,
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <span style={{ fontSize: 11.5, color: SUB, lineHeight: 1.45, display: "block" }}>
              Hand-stained solid Ash with a deep 45mm shadow-box profile. Creates the floating effect used by professional framers — a lifetime frame for a fraction of the bespoke price.
            </span>
          </div>
