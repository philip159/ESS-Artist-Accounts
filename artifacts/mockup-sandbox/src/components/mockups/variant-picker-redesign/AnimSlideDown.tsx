  ...
  return (
    <div style={{ width: 480, margin: "0 auto", padding: 32, fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <div style={{ marginBottom: 12, textAlign: "center" }}>
        <span style={{ fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em", color: SUB }}>A. Smooth Slide Down</span>
        <p style={{ fontSize: 11, color: FAINT, marginTop: 4 }}>CSS max-height transition with ease-out curve. Clean, standard feel.</p>
      </div>
