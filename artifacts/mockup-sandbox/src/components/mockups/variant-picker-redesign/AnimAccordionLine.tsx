...
export function AnimAccordionLine() {
  ...
  return (
    <div style={{ width: 480, margin: "0 auto", padding: 32, fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <div style={{ marginBottom: 12, textAlign: "center" }}>
        <span style={{ fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em", color: SUB }}>E. Line Wipe + Fade</span>
        <p style={{ fontSize: 11, color: FAINT, marginTop: 4 }}>A horizontal line sweeps across as cards fade in below. Refined, editorial.</p>
      </div>
